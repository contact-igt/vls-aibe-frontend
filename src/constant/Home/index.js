export const HomePageConstant = {
  navLink: [
    {
      id: 1,
      name: "Home",
      link: "https://www.vlslawacademy.com",
    },
    {
      id: 2,
      name: "Courses",
      link: "https://www.vlslawacademy.com/courses",
    },
    {
      id: 3,
      name: "Why VLS",
      link: "https://www.vlslawacademy.com/whyvls",
    },
    {
      id: 4,
      name: "Contact",
      link: "https://www.vlslawacademy.com/contact",
    },
  ],
  ...
  speaker: [
    {
      image: "/assets/mr-vanagamudi-backdrop.svg",
      name: "Mr. P. Vanangamudi",
      Education: "M.A., M.L., Ph.D (Law), Ph.D (History)",
      position: "Former Vice Chancellor, Tamilnadu Dr. Ambedkar Law University",
      about:
        "Since 1984, Mr. Vanangamudi successfully enrolled 1500 students for Tamil Nadu’s state-level law entrance. As an advocate, he has trained 7000+ students for the Tamil Nadu Judicial Services Exam (1997–2016). He mentored 750 candidates in subjects like the Constitution of India and law options for the UPSC and TNPSC exams (1987–2013)",
    },
